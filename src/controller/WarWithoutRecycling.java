...
/**
 * src.controller.WarWithoutRecycling.java
 *
 * @author Gideon Reyes
 *
 * src.controller.WarWithoutRecycling is an implementation of the card game "War". It implements a different set of rules
 ...
 */
public class WarWithoutRecycling implements WarType {
