...
public class WarUtils 
{
    ...
    public void compareWarCards(Player player1, Player player2)
    {
        ...
        {
            System.out.println("War card for Player 1 is " + player1.warDeck.get(player1WarDeckSize-1).toString());
            System.out.println("War card for Player 2 is " + player2.warDeck.get(player2WarDeckSize-1).toString());
